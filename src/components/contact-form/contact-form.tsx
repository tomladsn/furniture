            ...
            <div className={styles['contact-div']}>
                ...
                <div className={styles['contact-form']}>
                    <div className={styles['div-name-input']}>
                        <input className={styles['name-input']} placeholder="Naam:*" />
                    </div>

                    <div className={styles['div-email-input']}>
                        <input className={styles['email-input']} placeholder="Email" />
                    </div>
                    <input className={styles.subject} placeholder="Onderwerp" />
                    <textarea className={styles['message-input']} placeholder="Bericht" />
                    <button className={styles['submit-btn']}>
                        <p className={styles['submit-btn-txt']}>Verstuur</p>
                    </button>
                </div>
            </div>
        </div>
